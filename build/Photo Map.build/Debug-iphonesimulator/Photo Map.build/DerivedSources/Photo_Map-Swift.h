...
SWIFT_CLASS("_TtC9Photo_Map11AppDelegate")
...
SWIFT_CLASS("_TtC9Photo_Map23FullImageViewController")
...
SWIFT_CLASS("_TtC9Photo_Map12LocationCell")
...
@property (nonatomic, strong) NSDictionary * _Null_unspecified location;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC9Photo_Map23LocationsViewController")
@interface LocationsViewController : UIViewController <UIBarPositioningDelegate, UITableViewDataSource, UISearchBarDelegate, UIScrollViewDelegate, UITableViewDelegate>
@property (nonatomic, readonly, copy) NSString * _Nonnull CLIENT_ID;
@property (nonatomic, readonly, copy) NSString * _Nonnull CLIENT_SECRET;
...
- (void)fetchLocations:(NSString * _Nonnull)query near:(NSString * _Nonnull)near;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9Photo_Map22PhotoMapViewController")
